...
public class Line
{
    ...
    public void draw(Graphics2D g2) {
        if(p1.getZ() >= 0 && p2.getZ() >= 0) {
            ...
            Point p3 = new Point(p1.getX() + p1.getZ() * (p2.getX() - p1.getX()) / (p1.getZ() - p2.getZ()), p1.getY() + p1.getZ() * (p2.getY() - p1.getY()) / (p1.getZ() - p2.getZ()), 0);
            g2.draw(new Double(p1.get2Dx(), p1.get2Dy(), p3.get2Dx(), p3.get2Dy()));
        } else if (p2.getZ() >= 0) {
            Point p3 = new Point(p2.getX() + p2.getZ() * (p1.getX() - p2.getX()) / (p2.getZ() - p1.getZ()), p2.getY() + p2.getZ() * (p1.getY() - p2.getY()) / (p2.getZ() - p1.getZ()), 0);
